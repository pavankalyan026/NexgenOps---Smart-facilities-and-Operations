...
export const BookDemoSection: React.FC<BookDemoSectionProps> = ({ onOpenFounderModal }) => {
  const [formData, setFormData] = useState<DemoFormData>({
    ...
    organizationType: 'Commercial Office',
    message: '',
  });
  ...
  return (
    <section id="demo-form" className="py-20 md:py-28 bg-slate-50 dark:bg-[#060c18] relative border-t border-slate-200 dark:border-slate-850 transition-colors duration-200">
      {/* Background glow */}
        ...
        <div className="max-w-4xl mx-auto rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-750 p-6 sm:p-10 lg:p-12 shadow-xl dark:shadow-2xl dark:shadow-cyan-950/40">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="mt-3 text-sm sm:text-base text-slate-600 dark:text-slate-400">
              Schedule a tailored platform walkthrough and discover how NexgenOps unifies complaints, snags, maintenance, and stores.
            </p>
          </div>
          ...
          {isSubmitted ? (
            <div className="p-8 sm:p-10 rounded-2xl bg-emerald-50 dark:bg-slate-950/80 border border-emerald-300 dark:border-cyan-500/40 text-center animate-fadeIn">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white">Demo Request Confirmed!</h3>
              <p className="text-sm text-slate-700 dark:text-slate-300 mt-2 max-w-md mx-auto leading-relaxed">
                Thank you, <strong>{formData.fullName}</strong>. Our enterprise solutions lead will contact you at <strong>{formData.workEmail}</strong> within 2 business hours.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="workEmail" className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                    Work Email *
                  </label>
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="jobRole" className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  ...
                  >
                    ...
                    <option value="VP / Director of Real Estate">VP / Director of Real Estate</option>
                    <option value="Chief Engineer / MEP Lead">Chief Engineer / MEP Lead</option>
                    <option value="Property Owner / Developer">Property Owner / Developer</option>
                    <option value="Vendor / Service Contractor">Vendor / Service Contractor</option>
                    <option value="Other">Other Executive</option>
                  </select>
                </div>

                <div>
                  <label htmlFor="organizationType" className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  ...
                  >
                    ...
                    <option value="IT Tech Park / Campus">IT Tech Park / Campus</option>
                    <option value="Hospital & Healthcare">Hospital &amp; Healthcare</option>
                    <option value="Manufacturing & Industrial">Manufacturing &amp; Industrial</option>
                    <option value="Data Center & Mission Critical">Data Center &amp; Mission Critical</option>
                    <option value="Residential Gated Complex">Residential Gated Complex</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about the number of buildings, current tools (WhatsApp/spreadsheets), or urgent pain points..."
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 text-sm focus:outline-none focus:border-cyan-500 dark:focus:border-cyan-400 focus:ring-1 focus:ring-cyan-500 dark:focus:ring-cyan-400 transition-colors"
                />
              </div>
